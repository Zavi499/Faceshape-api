...
function setImage(img,src,fallback){if(!img||!src)return;img.classList.remove("is-hidden");img.onerror=()=>{if(fallback&&img.src!==fallback){img.src=fallback;return;}img.classList.add("is-hidden");};img.src=src;}
